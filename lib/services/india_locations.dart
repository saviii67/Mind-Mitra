...
/// along with their districts for cascading State -> District selection.
class IndiaLocations {
  ...
  static List<String> get states {
    final list = statesAndDistricts.keys.toList()..sort();
    return list;
  }
  ...
  static List<String> districtsForState(String? state) {
    ...
    final list = statesAndDistricts[state]!.map((e) => e.trim()).toList()..sort();
    return list;
  }
}
